...
const Doctors = () => {
  ...
  const getDoctors = async () => {
    try {
      const res = await axios.get("https://doc-backend-render.onrender.com/api/v1/admin/getAllDoctors", {
        headers: {
  ...
  const handleAccountStatus = async (record, status) => {
    try {
      const res = await axios.post(
        "https://doc-backend-render.onrender.com/api/v1/admin/changeAccountStatus",
        {
          doctorId: record._id,
